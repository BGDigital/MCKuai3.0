...
public class Options implements Serializable {
    ...
    public void setAudio_sound(Integer paramInteger)
    {
    ...
    public void setGame_lastcustomskin(Integer paramInteger)
    {
        this.game_lastcustomskin = paramInteger;
    }
    ...
    public void setGame_skintype(Integer paramInteger)
    {
        this.game_skintype = paramInteger;
    }

    public void setGame_thirdperson(Integer paramInteger)
    {
        this.game_thirdperson = paramInteger;
    }
